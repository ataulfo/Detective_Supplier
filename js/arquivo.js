...
//function redireciona(ID,NOME,RECOLHIMENTO,CONDICAO_TROCA,TELA,COMPRADOR,QUEM_RECEBE){
//window.open('altera_dados.php?'+ID+' '+NOME+' '+RECOLHIMENTO+' '+CONDICAO_TROCA+' '+TELA+' '+COMPRADOR+' '+QUEM_RECEBE+' ',"DescriptiveWindowName","left=100,top=100,width=600,height=560");
