...
function funcao_alterar_conta(ID,NOME,EMAIL,CONTA,STATUS){
window.open('alterarconta.php?id='+ID+'&nome='+NOME+'&email='+EMAIL+'&conta='+CONTA+'&status='+STATUS+'',"DescriptiveWindowName","left=100,top=100,width=520,height=440");
}    
